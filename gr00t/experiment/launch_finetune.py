...
if __name__ == "__main__":
    ...
    if ft_config.embodiment_tag is EmbodimentTag.UNITREE_G1_SMPL:
        config.model.action_horizon = len(
            config.data.modality_configs[embodiment_tag]["action"].delta_indices
        )
